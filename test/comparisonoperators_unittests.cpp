...
TEST_CASE("execute equal to operator", "[eq][execute]")
{
    ProgramUnit program;

    SECTION("execute a double-double equal to operator")
    {
        std::istringstream iss {"PRINT 4.0=3.0\nPRINT 3.0=4.0\nPRINT 3.0=3.0"};
        std::ostringstream oss;
    ...
    SECTION("execute a integer-double equal to operator")
    {
        std::istringstream iss {"PRINT 4=3.0\nPRINT 3=4.0\nPRINT 3=3.0"};
        std::ostringstream oss;
    ...
    SECTION("execute a double-integer equal to operator")
    {
        std::istringstream iss {"PRINT 4.0=3\nPRINT 3.0=4\nPRINT 3.0=3"};
        std::ostringstream oss;
    ...
    SECTION("execute a integer-integer equal to operator")
    {
        std::istringstream iss {"PRINT 4=3\nPRINT 3=4\nPRINT 3=3"};
        std::ostringstream oss;
...
TEST_CASE("recreate not equal to operator expressions", "[ne][recreate]")
{
    ProgramUnit program;
    std::ostringstream oss;

    SECTION("recreate a not equal to with two double constants")
    {
        std::istringstream iss {"PRINT 3.0<>2.0"};
    ...
    SECTION("recreate a not equal to with one integer and one double constant")
    {
        std::istringstream iss {"PRINT 3 <>2.0"};
    ...
    SECTION("recreate a not equal to with one double and one integer constant")
    {
        std::istringstream iss {"PRINT 3.0<> 2"};
    ...
    SECTION("recreate a not equal to with two integer constants")
    {
        std::istringstream iss {"PRINT 3 <> 2"};
...
TEST_CASE("execute not equal to operator", "[ne][execute]")
{
    ProgramUnit program;

    SECTION("execute a double-double not equal to operator")
    {
        std::istringstream iss {"PRINT 4.0<>3.0\nPRINT 3.0<>4.0\nPRINT 3.0<>3.0"};
        std::ostringstream oss;
    ...
    SECTION("execute a integer-double not equal to operator")
    {
        std::istringstream iss {"PRINT 4<>3.0\nPRINT 3<>4.0\nPRINT 3<>3.0"};
        std::ostringstream oss;
    ...
    SECTION("execute a double-integer not equal to operator")
    {
        std::istringstream iss {"PRINT 4.0<>3\nPRINT 3.0<>4\nPRINT 3.0<>3"};
        std::ostringstream oss;
    ...
    SECTION("execute a integer-integer not equal to operator")
    {
        std::istringstream iss {"PRINT 4<>3\nPRINT 3<>4\nPRINT 3<>3"};
        std::ostringstream oss;
